...
export default function Footer() {
  return (
    ...
    <div className='flex justify-center items-center mx-10  relative h-[80px]'> 
        ...
        <a href="" className='absolute right-0'><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none"
